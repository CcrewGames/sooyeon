...
public class MonsterScript : MonoBehaviour
{
    ...
    public void Layer()
    {
        ...
        ef1.GetComponent<LayerScript>().Layer();
        ef2.GetComponent<LayerScript>().Layer();
    ...
    public void Update()
    {
        ...
        if(Input.GetMouseButtonDown(0) && stage == 1)
        {
            ...
            if ((target == this.gameObject || target == num1 || target == num2) && GameObject.Find("Punch").GetComponent<PunchScript>().punchmode == 1 && damaged == false && GameObject.Find("Stage").GetComponent<Stage>().pausemode == false)
            {
        ...
        if(Input.GetMouseButtonDown(0) && stage == 3)
        {
            CastRay();
        ...
        if (Input.GetKeyDown(KeyCode.Space) && GameObject.Find("Punch").GetComponent<PunchScript>().punchmode == 1 && heart != 0) //임의 피격
        {
            OnDamaged();
            GameObject.Find("Punch").GetComponent<PunchScript>().re();
