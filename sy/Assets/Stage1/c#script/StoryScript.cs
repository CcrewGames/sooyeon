...
public class StoryScript : MonoBehaviour
{
    ...
    public void Story1On()
    {
        ...
        sentences1.Add("뭐야. 그새 어디로 사라진 거야?!");
    ...
    public void Story1_2On()
    {
        ...
        sentences1_2.Add("마찬가지로 큘의 부하들인가보군. 내가 전부 혼쭐을 내주지!");
    ...
    public void Story2On()
    {
        ...
        sentences2.Add("당신들 때문에 수많은 주민들이 고통받고 있습니다!"); //칼
        ...
        sentences2.Add("감히 그 분을 언급하다니! 자넨 절대 우리의 위대한 긍지를 이해할 수 없어!"); //로그십
        sentences2.Add("나의 1:2, 3:2 정수 비의 이상적 화음 공격 맛을 보게나!"); //로그십
    ...
    public void Story3On()
    {
        ...
        sentences3.Add("방심하지 마. 내가 죽어도 이 싸움은 계속될걸세..."); //로그십
