...
public class Story3Script : MonoBehaviour
{
    ...
    public void Story1On()
    {
        ...
        sentences1.Add("그래... 정말 오랜만이다. 칼, 넌 역시 하나도 변한 게 없어."); //큘
        ...
        sentences1.Add("아니! 적어도 나에겐 이들이 진짜 기사고 너희 계산기사단들이 나를 괴롭히는 괴물들이야!"); //큘
        sentences1.Add("내 검술 실력은 누구보다 출중했어. 떨어질 리가 없었다!"); //큘
    ...
    public void Story2On()
    {
        ...
        sentences2.Add("하! 과연 그럴까? 네 그 하늘로 치솟은 콧대를 꺾기 위헤 이번엔 끔찍한 수로 몰려오도록 해야 겠군!"); //큘
