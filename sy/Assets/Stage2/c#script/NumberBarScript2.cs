...
public class NumberBarScript2 : MonoBehaviour
{
    ...
    public void re()
    {
        ...
        i = 1;
        j = 1;
        random = punch.GetComponent<PunchScript2>().random;
        renummaker();
    ...
    public void nummaker()
    {
        ...
        if (i == 1)
        {
            ...
            spriteK.sprite = spritesM[punch.GetComponent<PunchScript2>().attack[1] - 1];
        ...
        else if (i == 2)
        {
            ...
            spriteL.sprite = spritesN[punch.GetComponent<PunchScript2>().attack[2]];
    ...
    void Stop1() //가운데로 모으기 바로 도착
    {
        ...
        int a = punch.GetComponent<PunchScript2>().result % 10; //일의 자리
        int b = (punch.GetComponent<PunchScript2>().result / 10) % 10; //십의 자리
        int c = punch.GetComponent<PunchScript2>().result / 100; //백의 자리
        ...
        if (punch.GetComponent<PunchScript2>().result > 99 && punch.GetComponent<PunchScript2>().result <= 999)
        {
        ...
        else if (punch.GetComponent<PunchScript2>().result > 9 && punch.GetComponent<PunchScript2>().result <= 99)
        {
            num1.transform.position = new Vector2(x0 + dis, height);
            num1.SetActive(true);
            num2.SetActive(true);
        ...
        else if (punch.GetComponent<PunchScript2>().result >= 0 && punch.GetComponent<PunchScript2>().result <= 9)
        {
